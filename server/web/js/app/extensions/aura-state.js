...
function(StateManager, NaiveComponent)
{
  ...
  return {
    ...
    initialize: function(app)
    {
      ...
      var allComponents = {
        "menu": new NaiveComponent("menu", {
          el: "#nav-menu-component",
          tagName: "nav",
          parent: "#header",
          index: 0
        }),
        "search": new NaiveComponent("search", {
          el: "#section-search-component",
          tagName: "section",
          parent: "#aside-side-pane",
          index: 0
        }),
        "collection": new NaiveComponent("collection", {
          el: "#section-collection-component",
          tagName: "section",
          parent: "#aside-side-pane",
          index: 1
        }),
        "datastore": new NaiveComponent("data-store", {
          el: "#section-data-store-component",
          tagName: "section",
          parent: "#aside-side-pane",
          index: 2
        }),
        "wall": new NaiveComponent("wall", {
          el: "#section-wall-component",
          tagName: "section",
          parent: "#section-content",
          index: 0
        }),
        "collection-form": new NaiveComponent("entity-form", {
          el: "#section-forms-component",
          entity: "collection",
          tagName: "section",
          className: "center-container overlay",
          parent: "body",
          index: 0
        }, ["entity"]),
        "datastore-form": new NaiveComponent("entity-form", {
          el: "#section-forms-component",
          entity: "datastore",
          tagName: "section",
          className: "center-container overlay",
        ...
        "visualization-form": new NaiveComponent("entity-form", {
          el: "#section-forms-component",
        ...
        "datasource-form": new NaiveComponent("entity-form", {
          el: "#section-forms-component",
          entity: "datasource",
          tagName: "section",
          className: "center-container overlay",
        ...
        "footer": new NaiveComponent("footer", {el: "#div-footer-component",
          tagName: "div",
